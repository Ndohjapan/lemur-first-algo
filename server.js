...
const keyId = "PK78KYT1Y1MK336L5DZ4"
const secretKey = "M6qwJYj5WlHE2I6ePCtlqaxIBruQM4kphKaETZzP"

const algoTrader = async (token, openId, paper, amount = 1000) => {
  ...
  wss.on("message", async function (message) {
    ...
    if (currentEvent.T === "n") {
      ...
      await fetch("https://api.openai.com/v1/chat/completions", {
        method: "POST",
        headers: {
          Authorization: "Bearer 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" ,
